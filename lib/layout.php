...
if($mobileLayout)
	include($libPath . "/layout_mobile.php");
else
	include($libPath . "/layout_nomobile.php");
...
{
	global $layout_links, $libPath;
	$bucket = "links"; include($libPath . "/pluginloader.php");
	$layout_links = $links;
}
