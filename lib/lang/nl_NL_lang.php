...
'Mod ID unspecified.' =>
'Mod-ID niet aangegeven.',

'already there' =>
'reeds hier',

'Pick a mod, any mod.' =>
'Kies een mod, welke dan ook.',
...
'Je moet een administator zijn om het bord in te stellen.',
...
'Forum unignored.' =>
'Forum niet meer genegeerd.',

'Mark forum read' =>
'Markeer forum als gelezen',

'Unignore forum' =>
'Forum niet meer negeren',
...
'Je kunt hier geen nieuwe threads starten.',
...
'Je mag geen gebruikerscommentaar posten.',
...
'Er zijn geen rangensets gedefinieerd',
...
'Niets is gepost in het laatste',
...
'Last known browser' =>
'Laatst bekende browser',


// pages/lostpass.php
'No sender specified for reset emails. Please check the board settings.' =>
'Geen afzender aangegeven voor reset e-mails. Graag even de bordinstellingen controleren.',

'This old key cannot be used.' =>
'Deze oude sleutel kan niet worden gebruikt.',
...
'Je wachtwoord is gereset naar <strong>{0}</strong>. Je kunt dit wachtwoord gebruiken om je aan te melden op het bord. We raden je aan het zo snel mogelijk te wijzigen.',
...
'Als je deze aanvraag niet hebt gedaan, kan dit bericht genegeerd worden.',
...
'Als je geen e-mail-adres in je profiel hebt aangegeven, heb je helaas pech. De oude methode, contact opnemen met een administrator vanaf buiten het bord, is nog steeds een optie.',
...
'Alleen administrators mogen IP-verbanningen beheren.',

'IP ban manager' =>
'IP-verbanningsbeheerder',
...
'Er zijn geen berichten om te tonen.',

'delete checked' =>
'verwijder aangevinkte',
...
'Je mag geen threads bewerken.',

'Move' =>
'Verplaats',

'Could not identify trash forum.' =>
'Kon het vuilnis forum niet identificeren.',
...
'Ik heb de {0}FAQ{1} gelezen',

'The word' =>
'Het woord',

'It\'s in the FAQ. Read it carefully and you\'ll find out what the word is.' =>
'Het zit in de FAQ. Lees het aandachtig door en je zult uitvinden wat het woord is.',
...
'Je wachtwoord moet minstens vier karakters lang zijn.',
...
'Je bent verbannen. Je kan niet posten.',

'Your power is not enough.' =>
'Je macht is niet genoeg.',

'This thread is locked.' =>
'Deze thread is gesloten.',
...
'Je staat op het punt om een oude thread omhoog te stoten. Dit is meestal een zeer slecht idee. Bedenk graag even wat je op het punt staat te doen voordat je op de Post knop drukt.',

'You can\'t double post until it\'s been at least one day.' =>
'Je kunt niet dubbelposten tot er een dag voorbij is.',

'Sorry' =>
'',

'You got ninja\'d. You might want to review the post made while you were typing before you submit yours.' =>
'Je bent geninja\'d. Wellicht wil je de post die gemaakt is terwijl je typte bekijken, voordat je die van jou post.',
...
'Je moet ingelogt zijn om je profiel te bewerken.',

'Banned users may not edit their profile.' =>
'Bannelingen mogen hun profiel niet bewerken.',

'Cannot edit a root user.' =>
'Je kunt een Root-gebruiker niet bewerken.',
...
'Maximale grootte is {0} bij {0} pixels.',

'Minipic' =>
'Miniplaatje',

'Administrative stuff' =>
'Administratieve zooi',
...
'Toon lijn tussen bericht en footer',

'As a staff member, you can upload pictures of any reasonable size.' =>
'Als staflid kun je plaatjes van iedere redelijke grootte uploaden.',
...
'Trying to ban a root user?' =>
'Probeer je nou een root-gebruiker te verbannen?',

'Invalid time given. Try again.' =>
'Ongeldige tijd opgegeven. Probeer het nog eens.',
...
'Bestand {0} is te groot. De limiet is {1} bytes, het gegeven bestand is {2} bytes.',

'Dimensions of {0} must be at most {1} by {1} pixels.' =>
'Formaat van {0} mag maximaal {1} bij {1} pixels zijn.',

'To change your password, you must type it twice without error.' =>
'Om je wachtwoord te veranderen, moet je het in tweevoud typen zonder fouten.',

'The display name you entered, "{0}", is already taken.' =>
'De display-naam die je hebt ingevoerd, "{0}", is al in gebruik.',
...
'Je bent gedegradeerd tot normale gebruiker.',
...
'Gefeliciteerd. Vergeet niet de regels te lezen aangaande je nieuwe macht.',
...
'Je moet ingelogd zijn om je posts te bewerken.',

'Banned users can\'t edit their posts.' =>
'Verbannen gebruikers kunnen hun posts niet bewerken.',

'Post ID unspecified.' =>
'Post-ID niet aangegeven.',

'You\'re not allowed to delete posts.' =>
'Je bent niet gemachtigd om posts te verwijderen.',

'You\'re not allowed to undelete posts.' =>
'Je bent niet gemachtigd om posts terug te zetten.',

'This post has been deleted.' =>
'',

'You are not allowed to edit posts.' =>
'Je bent niet gemachtigd om posts te bewerken.',

'This thread is closed.' =>
'Deze thread is gesloten.',

'Your post is too short to have any real meaning. Try a little harder.' =>
'Je post is te kort om echt betekenisvol te zijn. Doe wat beter je best.',
...
'Laat bezoekers zien van zo lang geleden:',
...
'Je moet aangemeld zijn om je avatars te kunnen bewerken.',
...
'Internal search' =>
'Interne zoekopdracht',

'Search help' =>
'Zoekhulp',

'Internal search checks both thread titles and post text, returning results from both.' =>
'Interne zoekfunctie controleert zowel thread titels als posttekst, en geeft resultaten van beiden.',

'Find entries with either term' =>
'Vind voorkomingen van beide termen apart',

'Find entries with full phrase' =>
'Vind voorkomingen van de hele zin',

'Find entries with <var>foo</var> but not <var>bar</var>' =>
'Vind voorkomingen van <var>foo</var> maar niet <var>bar</var>.',


// pages/thread.php
'You can\'t vote without logging in.' =>
'Je kan niet stemmen zonder ingelogt te zijn.',

'Poll\'s closed!' =>
'Poll\'s gesloten!',

'Invalid token.' =>
'Ongeldig veiligheidsmuntje.',
...
'Weet je zeker dat je op deze oude thread wil reageren? Dit zal de thread terug naar boven in de lijst zetten. Doe dit alleen maar als je iets nieuws en relevants te zeggen hebt binnen het onderwerp van deze thread dat niet beter in een nieuwe thread kan.',

'This thread is actually closed. Are you sure you want to abuse your staff position to post in a closed thread?' =>
'Deze thread is eigenlijk gesloten. Weet je zeker dat je je macht wil misbruiken om te reageren in een gesloten thread?',
...
'{0} gebruiker heeft tot nu toe gestemdt.',

'{0} users have voted so far' =>
'{0} gebruikers hebben tot nu toe gestemdt.',
...
'Het bestand "{0}" bestaat al. Verwijder de bestaande kopie voordat je de nieuwe upload.',
...
'Bestand is te groot. Maximumgrootte is {0}.',

'Uploading "{0}" would break the quota.' =>
'Het uploaden van "{0}" zou de quota overschrijden.',

'Forbidden file type.' =>
'Verboden bestandstype.',

'File "{0}" has been uploaded.' =>
'Bestand "{0}" is geupload.',

'You must be logged in to upload.' =>
'Je moet ingelogt zijn om te uploaden.',
...
'Bestand bestaat niet of is niet van jou.',
...
'De maximum uploadgrootte is {0} per bestand. Je kan de volgende bestandstypes uploaden: {2}.',

'File is too large.' =>
'Bestand is te groot.',

'File is not an allowed type.' =>
'Bestand is niet een toegelaten type.',

'Status' =>
'',

'Public space usage: {0} of {1}' =>
'Openbaar ruimtegebruik: {0} van {1}',

'Personal folder space usage: {0} of {1}' =>
'Persoonlijk ruimtegebruik: {0} van {1}',
...
'kleurgecodeert, gaat uit van C#',

'colorcoded block, specific language' =>
'kleurgecodeert, aangegeven taal',
...
'link to post by ID' =>
'verwijs naar bericht op ID',

'link to user\'s profile by ID' =>
'verwijs naar profiel op IP',
...
'Het meeste HTML ook toegelaten.',
...
'de IP verbanningen te bewerken',

'edit Local Moderator assignments' =>
'de moderatortoewijzingen te bewerken',
...
'edit your profile' =>
'je profiel te bewerken',

'edit the board settings' =>
'de instellingen van het board te bewerken',

'edit the smiley list' =>
'de smilies te bewerken',

'edit threads' =>
'threads te bewerken',

'edit users' =>
'gebruikers te bewerken',

'have a cookie' =>
'een koekje te nemen',

'see all posts by a given user' =>
'een lijst van alle berichten van een specifieke gebruiker te zien',

'post usercomments' =>
'commentaar te plaatsen',

'reply to threads' =>
'op threads te reageren',

'start new threads' =>
'nieuwe threads te beginnen',

'optimize the tables' =>
'de database te defragmenteren',

'purge old revisions' =>
'oude revisies te verwijderen',

'recalculate the board counters' =>
'de tellers te herberekenen',
...
'see the admin room' =>
'de administratiepagina te zien',

'see the avatar library' =>
'de avatarbibliotheek te zien',
...
'see the rank lists' =>
'de ranglijst te bekijken',

'see the top scores and DB usage' =>
'de topscores en het databasegebruik te zien',

'read threads' =>
'threads te lezen',

'see the uploader' =>
'de uploader in te zien',
...
'read this thread' =>
'deze thread te lezen',

'reply in this thread' =>
'in deze thread te reageren',

'edit this user' =>
'deze gebruiker te bewerken',
...
'Gebruiker is <strong>online</strong>',
...
'Als je met een andere account wil posten zonder te hoeven afmelden, vul dan de gebruikersnaam en het wachtwoord van die account hier in. Laat het wachtwoordveld blanco om de huidige account ({10}) te gebruiken.',

'SQL Console' =>
'SQL Console',

'(not admin-only)' =>
'(niet alleen voor admins)',
...
'Je kunt geen Root gebruiker verwijderen.',
...
'Gebruiker uitgeroeit. {0} is hier nooit geweest.',

'For more complex things, try PMA. This is just a toy-like quick access.' =>
'Voor meer complexe dingen moet je PMA maar proberen. Dit is slechts een vlug speeltje.',

'You must be an administrator to edit the forum list.' =>
'Je moet administrator zijn om de forumlijst te bewerken.',
...
'Je moet een administrator zijn om de Aandachtspunten te bewerken.',
...
'Autolock months' =>
'Maanden voor automatisch op slot zetten',

'Bump warning months' =>
'Maanden voor omhoogstootwaarschuwing',

'Viewcount report interval' =>
'Interval voor aangeven van aantal bezichtigingen',

'Custom title threshold' =>
'Aangepaste titel drempelwaarde',
...
'System user ID' =>
'Systeemgebruikers-ID',

'Minimal word count' =>
'Minimaal aantal woorden',

'This is supposed to protect your board from the Happyface Guy, who floods a single smiley.' =>
'Dit is bedoeld om je bord the beschermen tegen Happyface Guy, die een overvloed aan enkele smilies post.',

'Set this to zero to disable the check, at your own risk.' =>
'Zet dit op nul om de controle uit te schakelen, op eigen risico.',

'Minimal seconds between posts' =>
'Minimaal aantal seconden tussen posts',

'This is supposed to protect your board from flooders by slowing them down.' =>
'Dit is bedoeld om je bord te beschermen tegen spammers die een overvloed aan posts maken, door ze af te remmen.',
...
'Uploader whitelist' =>
'Uploader witte lijst',

'Mail Reset sender' =>
'Mail Reset afzender',

'Time limit for Last Posts' =>
'Tijdslimiet voor Laatste Posts',
...
'Je mag deze categorie niet zien.',

'Would you like to {0}post something{1}?' =>
'Wil je {0}iets posten{1}?',

'{0}Log in{1} so you can post something.' =>
'{0}Meld je aan{1} zodat je iets kunt posten.',
...
'Kon geen gebruiker vinden met die naam en dat e-mail-adres.',
...
'Je hebt al het laatste woord.',

'Another user is already using this IP address.' =>
'Een andere gebruiker heeft dit IP adres al.',

'You are now registered and logged in.' =>
'Je bent nu geregistreerd en aangemeld.',
